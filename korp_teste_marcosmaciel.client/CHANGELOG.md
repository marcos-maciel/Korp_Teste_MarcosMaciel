...
- Crie um projeto angular com ng: `ng new korp_teste_marcosmaciel.client --defaults --skip-install --skip-git --no-standalone `.
...
- Criar o arquivo de projeto (`korp_teste_marcosmaciel.client.esproj`).
